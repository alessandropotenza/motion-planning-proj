...
# Franka (7-DOF) counterpart of 2Dexamples/data_analysis2D_scatter.py.
# -----------------------------------------------------------------------------
...
def plot_scene_x_vs_path_cost(
    ...
    *,
    ...
    for pi, planner in enumerate(planners):
        ...
        ax.scatter(
            [], [], color=color, s=42, edgecolors="black", linewidths=0.35,
            label=DISPLAY_LABELS.get(planner, planner),
        )
...
def main() -> None:
    parser = argparse.ArgumentParser(
        ...
        "(checkpoints + first-path rows). Franka (7-DOF)."
    )
    parser.add_argument(
